...
interface EquipmentAddDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (equipment: EquipmentFormData) => Promise<void>;
...
const EquipmentAddDrawer: React.FC<EquipmentAddDrawerProps> = ({
  isOpen,
  onClose,
  onSave,
  equipment,
  ...
  const processDescription = async () => {
    ...
    try {
      ...
      if (mockSuggestions.length === 0) {
        setError('No matches found. Try adjusting your description or enter details manually.');
        setShowForm(true);
      }
    } catch (err) {
  ...
  const drawerContent = (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-4 sm:p-6">
        ...
        {showForm && (
          <div className="bg-white px-4 py-5 sm:rounded-lg sm:p-6 mt-6">
                ...
                <div className="sm:col-span-6">
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input
                      ...
                      onChange={handleFormChange}
                      className="focus:ring-coffee-500 focus:border-coffee-500 block w-full pl-7 sm:text-sm border-gray-300 rounded-md"
                    />
                  </div>
                </div>
      ...
      {showForm && (
        <div className="flex-shrink-0 border-t border-gray-200 px-4 py-5 sm:px-6">
          <div className="flex justify-end space-x-3">
            <button
              type="button"
              className="py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-coffee-500"
              onClick={onClose}
            >
              Cancel
            </button>
...
export default EquipmentAddDrawer; 